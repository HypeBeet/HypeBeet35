...
def tic_tac_toe():
    ...
    win_commbinations = ((1, 2, 3), (4, 5, 6), (7, 8, 9), (3, 6, 9), (1, 4, 7), (2, 5, 8), (1, 5, 9), (3, 5, 7 ))
    ...
    def p1():
        n = choose_number()
        if board[n] == "P" or board[n] == "Q":
            print("\nThat's off limits Mr Roaden :(")
            p1()
        else:
            board[n] = "P"
    ...
    def check_board():
        ...
        for a in range(9):
            if board[a] == "P" or board[a] == "Q":
                count += 1
            if count == 9:
                print("Tie, Neither watched their Ps or Qs\n")
                return True
